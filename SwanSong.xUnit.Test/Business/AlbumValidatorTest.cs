...
namespace SwanSong.xUnit.Test.Business
{
    public class AlbumValidatorTest
    {
        ...
        [Fact]
        public void Before_save_validate_album_return_true()
        { 
            ValidationResult validation = validator.Validate(CreateAlbum(), options => options
                                                                                .IncludeRuleSets("BeforeSave"));
            Assert.True(validation.IsValid); 
        }

        [Fact]
        public void After_save_validate_album_return_true()
        {
            ValidationResult validation = validator.Validate(CreateAlbum(), options => options
        ...
        [Fact]
        public void Before_save_validate_album_no_artist_id_return_false()
        {
            Album album = CreateAlbum();
            album.ArtistId = 0;
            ValidationResult validation = validator.Validate(album, options => options
                                                                                .IncludeRuleSets("BeforeSave"));
            Assert.False(validation.IsValid);
        ...
        [Fact]
        public void Before_save_validate_album_album_name_null_return_false()
        {
        ...
        [Fact]
        public void Before_save_validate_album_album_name_empty_return_false()
        {
        ...
        [Fact]
        public void Before_save_validate_album_album_name_greater_than_120_return_false()
        {
        ...
        [Fact]
        public void Before_save_validate_existing_album_album_name_exists_return_false()
        {
        ...
        [Fact]
        public void Before_save_validate_new_album_album_name_exists_return_false()
        {
        ...
        [Fact]
        public void Before_save_validate_album_album_length_invalid_return_false()
        {
            Album album = CreateAlbum();
            album.Length = "44";
            ValidationResult validation = validator.Validate(album, options => options
        ...
        [Fact]
        public void Before_save_validate_album_release_date_less_than_1900_01_01_return_false()
        {
            Album album = CreateAlbum();
        ...
        [Fact]
        public void Before_save_validate_album_recorded_date_less_than_1900_01_01_return_false()
        {
            Album album = CreateAlbum();
        ...
        [Fact]
        public void Before_save_validate_album_release_date_less_than_recorded_date_return_false()
        {
            Album album = CreateAlbum();
        ...
        [Fact]
        public void Before_save_validate_album_album_producers_greater_than_250_return_false()
        {
            Album album = CreateAlbum();
        ...
        [Fact]
        public void Before_save_validate_album_album_arrangers_greater_than_250_return_false()
        {
            Album album = CreateAlbum();
        ...
        [Fact]
        public void Before_save_validate_album_album_engineers_greater_than_250_return_false()
        {
            Album album = CreateAlbum();
        ...
        [Fact]
        public void Before_save_validate_album_album_artwork_greater_than_250_return_false()
        {
            Album album = CreateAlbum();
