    ...
    public class Albums
    {
        public static List<Album> GetAlbumDefaultData()
        {
            return new List<Album>()
            {
                ...
                new Album { Id = 2, Name = "The North Star Grassman and the Ravens", ArtistId = 2, ReleaseDate = new DateTime(1986, 9, 1), LabelId = 7, RecordedDate = new DateTime(1971, 9, 1), StudioId = 1, Length = "39:41", Producers = "John Wood, Richard Thompson, Sandy Denny", Arrangers = "Sandy Denny", Engineers = "John Wood", Artwork = "Keef", Photo = "e3b74057-75df-4cfe-ba42-9ed4f57623f5.jpg"},
